...
public class AuthServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("  \r\n"
				...
				+ "<input type='submit' class=\"button1\" value='Update Address'>"
				+ "</form><br><br>\r\n"
				+ "  				<a href=\"UserViewServlet\"class = \"button2\">View Address</a><br><br><br>	 \r\n"
				+ "  				<a href=\"index.jsp\"class = \"button2\">Log Out</a><br>	 \r\n"
				+ "		</div>\r\n"
				+ "	</div>\r\n"
				+ "	 \r\n"
				+ "</body>\r\n"
