...
public class LoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		UserLoginDatabase checking = new UserLoginDatabase();
		String CorrectOrIncorrect = "0";
		try {
			CorrectOrIncorrect = checking.validate(mobile,password);
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
		if(!"0".equals(CorrectOrIncorrect)) {
			String aadharNo = CorrectOrIncorrect;
			out.println("  \r\n"
					+ "<html>\r\n"
					+ "<head>\r\n"
					...
					+ "	<div class = \"admin\">\r\n"
					+ "		<div class = \"form-box\">\r\n"
					+ "				<h1 style=\"font-size: 30px; margin-top: 20px;\">SuccessFully Logged In!</h1><br><br><br><br>\r\n"
					+ "             <h3 style=\"font-size: 30px; margin-top: 20px;\">Your Registered Aadhar Number: "+aadharNo+"</h3><br><br><br><br>\r\n"
			...
			out.println("  \r\n"
					...
					+ "	<div class = \"admin\">\r\n"
					+ "		<div class = \"form-box\">\r\n"
					+ "				<h1 style=\"font-size: 30px; margin-top: 20px;\">Invalid Credentials!</h1><br><br><br><br>\r\n"
					+ "				<h1 style=\"font-size: 30px; margin-top: 20px;\"><center>Please Login Again</center></h1><br><br><br><br>\r\n"
					+ "<form>"
